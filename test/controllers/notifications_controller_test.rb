...
class NotificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notification" do
    assert_difference('Notification.count') do
      post notifications_url, params: { notification: { note: @notification.note, read: @notification.read, user_id: @notification.user_id } }
    end
  ...
  test "should update notification" do
    patch notification_url(@notification), params: { notification: { note: @notification.note, read: @notification.read, user_id: @notification.user_id } }
